...
const projects = [
  ...
  {
    title: "Flowline",
    description: "A modern, high-performance task management platform engineered for fluid workflows and uninterrupted focus.",
    fullDescription: "Flowline eliminates work friction with intuitive task orchestration, instant command palette navigation, and real-time progress tracking. Built on React 19, Vite, and TanStack Query, it delivers lightning-fast UI updates, optimistic state management, and seamless daily planning.",
    tags: ["React 19", "TypeScript", "Vite", "Tailwind CSS", "TanStack Query"],
    highlights: [
      "Fluid task orchestration & live progress tracking",
